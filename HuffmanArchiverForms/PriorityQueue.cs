...
namespace HuffmanArchiverForms
{
	internal class PriorityQueue<T>
	{
		...
		public T Dequeue() // для получения элемента из приор очереди, перебираем очереди в порядке их приоритета, и как только находим непустую, возвращаем значение из неё
		{
			if (size == 0)
